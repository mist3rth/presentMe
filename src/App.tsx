...
import { ValueDriversPinnedSection } from './components/sections/ValueDriversPinnedSection';
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#050302] text-white flex flex-col font-sans selection:bg-[#F97316] selection:text-white overflow-x-hidden">
      ...
      <div id="vision-manifeste" className="scroll-mt-24" />
      <section 
      ...
      {/* SECTION: 9 leviers de valeur (Sticky Pinned scroll) */}
      <ValueDriversPinnedSection />
